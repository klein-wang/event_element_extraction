...
if __name__ == "__main__":
    ...
    print("save enum tag {} at {}".format(len(tags_enum), tags_enum_path))
    ...
    print("train {} dev {}".format(len(train_tri), len(dev_tri)))
    ...
    print("train {} dev {}".format(len(train_role), len(dev_role)))
    ...
    print("train {} dev {}".format(len(trian_enum), len(dev_enum)))
